/*
 *   @(#) $Id: StringToInetAddressConverter.java 112 2005-10-01 13:05:13Z trustin $
 *
 ...
 */
public class StringToInetAddressConverter extends Converter {

	public StringToInetAddressConverter() {
        super(String.class, InetAddress.class);
	}

	public Object doConversion(Object o, ConverterContext ctx) throws UnknownHostException {
