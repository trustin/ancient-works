/*
 *   @(#) $Id: ObjectNameToStringConverter.java 113 2005-10-01 13:06:43Z trustin $
 *
 ...
 */
public class ObjectNameToStringConverter extends Converter {

	public ObjectNameToStringConverter() {
        super(ObjectName.class, String.class);
	}
