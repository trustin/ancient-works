/*
 *   @(#) $Id: StringToCurrencyConverter.java 113 2005-10-01 13:06:43Z trustin $
 *
 ...
 */
public class StringToCurrencyConverter extends Converter {
	...
	public Object doConversion(Object o, ConverterContext ctx) {
		return Currency.getInstance((String)o);
	}
}
