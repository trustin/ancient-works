/*
 *   @(#) $Id: StringToCharsetConverter.java 113 2005-10-01 13:06:43Z trustin $
 *
 ...
 */
public class StringToCharsetConverter extends Converter {
	...
	public Object doConversion(Object o, ConverterContext ctx) {
		return Charset.forName((String)o);
	}
}