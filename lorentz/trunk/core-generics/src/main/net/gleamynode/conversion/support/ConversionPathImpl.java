...
public class ConversionPathImpl implements ConversionPath {
    ...
    private final List<Converter> path = new ArrayList<Converter>();
    ...
    public List<Converter> toList() {
        return new ArrayList<Converter>( path );
    }
    ...
    public Object convert(Object source, ConverterContext ctx) {
        ...
        try {
            for (Iterator<Converter> i = path.iterator(); i.hasNext();) {
                result = (i.next()).doConversion(result, ctx);
            }
        } catch (Exception e) {
    ...
    public void copy(Object source, Object target, ConverterContext ctx) {
        ...
        Object result = source;
        Iterator<Converter> i = path.iterator();
        try {
            for (;;) {
                Converter c = i.next();
                if (i.hasNext()) {
    ...
    public ConversionPathImpl clone() {
