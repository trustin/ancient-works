...
public abstract class Converter implements Comparable {
     ...
     * @throws ConversionException if failed to convert
     */
    public static <T> T convert(Object source, Class<T> targetType, ConverterContext ctx)
            throws ConversionException {
        if (ctx == null) {
     ...
     * @return <tt>null</tt> if failed to convert
     */
    public static <T> T safeConvert(Object source, Class<T> targetType, ConverterContext ctx) {
        try {
    ...
    public static void setDefaultContext(ConverterContext defaultContext) {
        ...
        Converter.defaultContext = defaultContext.clone();
    }
